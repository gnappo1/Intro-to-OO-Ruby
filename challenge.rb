...
# Create a class method to keep track of all of the people ever created/born [BONUS]
# Create a class method to find all of the people from a certain hometown [SUPER BONUS]